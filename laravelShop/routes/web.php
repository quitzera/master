...
Route::get('selectMenu','Vx\\AdminController@selectMenu');
Route::get('accept','Vx\\AdminController@accept');
Route::get('selectMaterial','Vx\\AdminController@selectMaterial');
...
Route::any('saveImage','Vx\\AdminController@saveImage');
Route::any('confirm','Vx\\AdminController@confirm');
Route::any('status','Vx\\AdminController@status');
Route::any('saveInfo/{openid}','Vx\\AdminController@saveInfo');
...
Route::get('createCode','Vx\\AdminController@createCode');
Route::get('wxCode/{id}','Vx\\AdminController@wxCode');
Route::get('wdnmd','Vx\\AdminController@wdnmd');
