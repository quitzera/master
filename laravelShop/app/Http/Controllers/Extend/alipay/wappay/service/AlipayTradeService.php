 ...
 */
namespace App\Http\Controllers\Extend\Alipay\Wappay\Service;

use App\Http\Controllers\Extend\Alipay\Aop\Request\AlipayTradeWapPayRequest;
use App\Http\Controllers\Extend\Alipay\Aop\AopClient;
require_once app_path().'/Http/Controllers/Extend/alipay/AopSdk.php';
config('alipay');
